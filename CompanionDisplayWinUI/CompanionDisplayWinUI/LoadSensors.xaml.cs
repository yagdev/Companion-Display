...
namespace CompanionDisplayWinUI
{
    ...
    /// </summary>
    public sealed partial class LoadSensors : Page
    {
        public LoadSensors()
        {
        ...
        {
            Sensors.UpdateSensorValue(sensor1, LastValue, LoadPercent, TempProgress, AppStrings.sensorsLoad, DispatcherQueue, false);
        }
    }
}
