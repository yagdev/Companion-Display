        ...
        private void UpdateUI()
        {
            if (sensor1 != null)
            {
                ...
                try
                {
                    ...
                    if ((Globals.CurrentHW == sensor1.Hardware || Globals.CurrentHW == sensor1.Hardware.Parent) && ((Math.Round((float)(sensor1.Value) * 100)) / 100) != LastValue)
                    {
                        LastValue = (Math.Round((float)(sensor1.Value) * 100)) / 100;
                        try
                        {
